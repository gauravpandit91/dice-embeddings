...
class TestQueryAnswering:
       ...
       def test_query_answering_family(self):
              ...
              # Query 4: Who are the parents of F10F175?
              predictions = pre_trained_kge.answer_multi_hop_query(query_type="1p",
                                                               query=('http://www.benchmark.org/family#F10F175',
                                                                      ('http://www.benchmark.org/family#hasParent',)),
                                                               tnorm="min", k=2)
              ...
              # Question 5 : Who are the individuals that have a sibling who is also their child
              predictions = pre_trained_kge.answer_multi_hop_query(query_type="3p",
                                                               query=('http://www.benchmark.org/family#F10F193',
                                                                      ( 'http://www.benchmark.org/family#hasParent',
                                                                             'http://www.benchmark.org/family#hasSibling',
              ...
              # Question 6: Person who have siblings that are also parents?
              predictions = pre_trained_kge.answer_multi_hop_query(query_type="2p",
                                                               query=('http://www.benchmark.org/family#Person',
                                                                      ('http://www.benchmark.org/family#hasSibling',
                                                                      "http://www.benchmark.org/family#hasChild")),
                                                               tnorm="min", k=3)
              top_entities = [topk_entity for topk_entity, query_score in predictions]
              ...
              '''
              # Question 7: List the parents of the daughters in the family.
              predictions = pre_trained_kge.answer_multi_hop_query(query_type="1p",
                                                               query=('http://www.benchmark.org/family#Daughter',
                                                                             ('http://www.benchmark.org/family#married')),
                                                               tnorm="min", k=2)
              top_entities = [topk_entity for topk_entity, query_score in predictions]
              print(top_entities)
              ...
              # Question 8: Grandsons who have siblings & are married?
              predictions = pre_trained_kge.answer_multi_hop_query(query_type="2p",
                                                               query=('http://www.benchmark.org/family#Grandson',
                                                                      ('http://www.benchmark.org/family#hasSibling',
                                                                      "http://www.benchmark.org/family#married")),
                                                               tnorm="min", k=3)
              top_entities = [topk_entity for topk_entity, query_score in predictions]
